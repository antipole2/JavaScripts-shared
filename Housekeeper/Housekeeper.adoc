...
There is a https://github.com/antipole2/JavaScripts-shared/blob/main/Housekeeper/Housekeeper_tech_guide.adoc[technical description] that documents how the script works.
