...
If you remove one of these routepoints from the route, it becomes a free-standing waypoint.|Freestanding waypoints with names like 0001, 002, NM020 and with an icon name of 'diamond' which are no longer included in any route can be removed.
|===
