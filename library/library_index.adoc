...
This has the advantage of version control if you modify it.

I keep my published scripts in a GitHub repository synchronised to a folder on my computer using GitHub Desktop.
They are thus available to me when offline afloat.  Any modifications I might make get synchronised back to the published version.
