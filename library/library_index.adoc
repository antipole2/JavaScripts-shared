...
|link:https://raw.githubusercontent.com/antipole2/JavaScripts-shared/main/Housekeeper/Housekeeper.js[Housekeper.js]
|Examines your waypoints & routes for anomolies and offers to fix them.
|link:https:../Housekeeper/Housekeeper_tech_guide.adoc[Fuller description and instructions]
|Antipole
|===
