...
If your gateway is not also a router, you need a WiFi router and need to connect your gateway as a client of that network.  You could use a 12V-powered WiFI router (an create readily available) or your computer may be able to provide this.  MacOS can create a WiFi network and then functions as a WiFi router.
