...
You need to make sure the routepoint names are unique.
A good way of achieving this is to use the link:https:../Housekeeper/Housekeeper.adoc[Housekeeper script].
====
