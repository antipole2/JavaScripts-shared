...
* A series of WPL sentences defining the waypoints in the route
* A group of RTE sentences creating a route comprising the waypoints
* A BOD sentence with the bearing from the position at which the leg was activated to the next route point.
